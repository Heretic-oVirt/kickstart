...
# oVirt Host hyperconverged disk configuration: there will surely be multiple SCSI/SATA disks but only one will be used for OS
...
logvol /var/crash --vgname=HostVG --name=var_crash --size=12000
...
# Note: disabling includes in all yum commandline invocations to work around includepkgs lines inside oVirt dependency repo file - they are meant to avoid accidental upgrades according to https://bugzilla.redhat.com/show_bug.cgi?id=1552929
...
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.1//EN" "http://www.w3.org/TR/xhtml11/DTD/xhtml11.dtd">
	<head>
		<title>Heretic oVirt Project - Hypervisor Server</title>
	...
	<body>
	<h1>Heretic oVirt Project - Hypervisor Server</h1>

		<div class="content">
			<div class="content-columns">
				<div class="content-column-left">
					<h2>Avvertenza per gli utenti del servizio:</h2>
					<p>Questa macchina fornisce servizi di virtualizzazione legati al progetto Heretic oVirt.</p>
					</p>
				...
				<div class="content-column-right">
					...
					<p>This machine hosts Heretic oVirt Project virtualization services.</p>
					</p>
